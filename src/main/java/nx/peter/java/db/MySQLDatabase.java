...
public class MySQLDatabase {
    ...
    public TableUpdateFeedback createTable(Object data) {
        ObjectDetail<?> detail = Advanced.getObjectDetail(data);
    ...
    public static class IdSpec {
        ...
        protected int id;
        protected DataState spec;

        public IdSpec(String key, int id, DataState spec) {
            this.key = key;
            this.id = id;
            this.spec = spec;
        }
    ...
    public static class DataSpec {
        ...
        public DataSpec(String key, String value) {
            this.key = key;
            this.value = value;
        }
    }
    ...
    public static class UpdateFeedback {
        ...
        public UpdateFeedback(String message, int count) {
    ...
    public static class TableUpdateFeedback {
        private static String type = "Updated";
        protected String message;
        protected int updatedTableCount;
        protected boolean isUpdated;

        public TableUpdateFeedback(String message, int updatedTableCount, boolean isUpdated) {
            this.message = message;
            this.updatedTableCount = updatedTableCount;
    ...
    public static class DataUpdateFeedback {
        private static String type = "Updated";

        protected String message;
        protected int updatedDataCount;
        protected boolean isUpdated;

        public DataUpdateFeedback(String message, int updatedDataCount, boolean isUpdated) {
            this.message = message;
            this.updatedDataCount = updatedDataCount;
            this.isUpdated = isUpdated;
        }

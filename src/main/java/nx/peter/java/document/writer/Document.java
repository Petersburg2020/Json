...
import nx.peter.java.document.Pages;
...
public interface Document<D extends Document, P extends nx.peter.java.document.writer.Page> extends
     ...
     *
     * @param pages the list of pages provided
     */
    <A extends Page> D setPages(A... pages);
     ...
     * @param pages the list of pages provided
     */
    <A extends Page> D setPages(List<A> pages);
     ...
     * @param pages the list of pages provided
     */
    <A extends Page> D setPages(Pages<A> pages);
     ...
     * @param pages the list of pages provided
     */
    <A extends Page> D addPages(A... pages);
     ...
     * @param pages the list of pages provided
     */
    <A extends Page> D addPages(Pages<A> pages);
     ...
     */
    <A extends Page> D addPages(List<A> pages);
     ...
     * @param pages the list of page provided
     */
    <A extends Page> D removePages(A... pages);
     ...
     * @param pages the list of page provided
     */
    <A extends Page> D removePages(List<A> pages);

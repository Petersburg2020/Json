...
public abstract class DocumentCore<D extends DocumentCore, Doc extends Document, N extends Node, J extends JsonElement> {
    ...
    public DocumentCore(Document.Type type) {
        ...
        document = null;
        switch (type) {
            case Book: case Unknown: document = (Doc) new Book(); break;
            case Journal: document = (Doc) new Journal(); break;
            case Magazine: document = (Doc) new Magazine(); break;
            case NewsPaper: document = (Doc) new NewsPaper(); break;
            case Thesis: document = (Doc) new Thesis();
        };
    }
